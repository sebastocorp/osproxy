...
Common labels
*/}}
{{- define "osproxy.labels" -}}
helm.sh/chart: {{ include "osproxy.chart" . }}
{{ include "osproxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "osproxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "osproxy.name" . }}
